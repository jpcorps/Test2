Shader "ProjectH/CharacterBlend_hero" 
{
	Properties
	{
	...
	SubShader
	{
		...
		{ 
			...
			float4 frag(v2f i):COLOR
			{
				...
				if(view_dot_nor > -0.00001)
				{
					col.rgb += rim * 0.5;

					float edge_step = step(_EdgeMin, view_dot_nor);
